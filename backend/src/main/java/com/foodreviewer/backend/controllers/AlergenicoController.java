...
public class AlergenicoController {
    ...
    @PostMapping
    public ResponseEntity<Alergenico> criarAlergenico( @RequestBody Alergenico alergenico){
    ...
    @PutMapping
    public ResponseEntity<Optional<Alergenico>> updateAlergenico(@PathVariable Long id,  @RequestBody Alergenico alergenico){
        try{
