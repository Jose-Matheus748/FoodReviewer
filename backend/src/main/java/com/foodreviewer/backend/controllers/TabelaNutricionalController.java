...
public class TabelaNutricionalController {
    ...
    @PostMapping
    public ResponseEntity<TabelaNutricional> criarTabelaNutricional(@RequestBody TabelaNutricional tabelaNutricional){
    ...
    @PutMapping
    public ResponseEntity<Optional<TabelaNutricional>> updateTabelaNutricional(@PathVariable Long id, @RequestBody TabelaNutricional tabelaNutricional){
        try{
